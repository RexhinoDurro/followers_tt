...
export default function TikTokGrowthPage() {
  ...
  const features = [
    {
      ...
      details: [
        ...
        "Interest-based follower acquisition",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! We only use organic methods to attract real, active TikTok users who are genuinely interested in your content and niche.",
    },
    {
      question: "Is this safe for my TikTok account?",
      answer:
        "Absolutely. All our methods are 100% compliant with TikTok's terms of service. We use only organic growth strategies to protect your account.",
    },
    {
      question: "What information do you need from me?",
      answer:
        "We only need your TikTok username and basic information about your target audience and goals. We never ask for passwords or sensitive information.",
    },
    {
      question: "Can I target specific demographics?",
      answer:
        "Yes! We can target followers based on location, interests, age, gender, and similar accounts to ensure you get the most relevant audience.",
    },
  ]
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 leading-relaxed">
                Get real, engaged followers who love your content. Our proven strategies help you build an authentic
                TikTok presence that converts.
              </p>
              ...
              {[
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-md font-medium transition-all duration-200 flex items-center ${
                    activeTab === tab.id ? "bg-white shadow-md text-black" : "text-gray-600 hover:text-gray-900"
                  }`}
                >
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Grow Your TikTok?</h2>
