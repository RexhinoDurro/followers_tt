      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
            ...
            <div className="mt-6 text-center">
              <button onClick={() => setIsLogin(true)} className="text-sm text-gray-600 hover:text-purple-600">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                ...
                <div className="space-y-1">
                  <div className="flex items-center text-sm">
                    <CheckCircle
                      className={`w-4 h-4 mr-2 ${formData.password.length >= 8 ? "text-green-500" : "text-gray-300"}`}
                    />
