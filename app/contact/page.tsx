  ...
  const faqs = [
    {
      ...
      answer:
        "We aim to respond to all support requests within 24 hours during business days. Premium users receive priority support with responses within 4 hours.",
    },
    {
      question: "Do you offer phone support?",
      answer:
        "Yes! Phone support is available for Enterprise customers. Please contact your account manager or email sales@yourplatform.com to set up a call.",
    },
    {
      question: "Can I schedule a demo?",
      answer:
        "We offer personalized demos for businesses and teams. Use our contact form or email sales@yourplatform.com to schedule your demo.",
    },
    {
      question: "How do I report a bug or technical issue?",
      answer:
        "Please use our contact form with 'Technical Support' selected, or email support@yourplatform.com with detailed information about the issue.",
    },
  ]
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-light px-2">
            We&apos;re here to help! Get in touch with our team for support, sales inquiries, partnerships, or just to
            say hello.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {contactMethods.map((method, index) => (
              <div
                key={index}
                className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              >
                <div
                  className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r ${method.color} rounded-xl sm:rounded-2xl flex items-center justify-center text-xl sm:text-2xl mb-3 sm:mb-4`}
                >
                  {method.icon}
                </div>
                ...
                <div className="space-y-1 sm:space-y-2">
                  <a
                    ...
                    className="text-blue-600 hover:text-blue-800 font-medium text-xs sm:text-sm block break-all"
                  >
                    {method.email}
                  </a>
                  <div className="text-green-600 text-xs font-medium">⚡ {method.responseTime}</div>
                </div>
              </div>
            ))}
          </div>
