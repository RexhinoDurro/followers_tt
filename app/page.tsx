...
// app/page.tsx - Homepage migrated from Vite app
  ...
  const testimonials = [
    {
      ...
      image: "👩‍💼",
      content:
        "In just 3 months, my Instagram grew from 5K to 50K followers. The engagement is incredible and all followers are real people who actually care about my content.",
    ...
    },
    {
      ...
      image: "👨‍💻",
      content:
        "My YouTube channel finally hit monetization requirements! The subscribers are genuine gamers who actually watch my content. Revenue has increased 10x.",
    ...
    },
    {
      ...
      image: "👩‍🎨",
      content:
        "Three of my videos went viral after working with this team. They understand the TikTok algorithm better than anyone. My follower count exploded overnight.",
  ...
  const features = [
    {
      ...
      description: "No bots or fake accounts. Every follower is a real person.",
    },
    { icon: Clock, title: "Fast Delivery", description: "See results within 24-72 hours of starting your campaign." },
    {
      icon: Shield,
      title: "100% Safe",
      description: "Compliant with all platform guidelines. Your account stays secure.",
    },
    {
      icon: CreditCard,
      title: "Money-Back Guarantee",
      description: "30-day guarantee. Not satisfied? Get your money back.",
    },
    {
      icon: Growth,
      title: "Organic Growth",
      description: "Natural growth patterns that look authentic to algorithms.",
    },
    {
      icon: Target,
      title: "Targeted Audience",
      description: "Reach people who are genuinely interested in your content.",
    },
  ]
    ...
    <PublicLayout>
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-white rounded-xl sm:rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden group"
                >
                  <div
                    className={`bg-gradient-to-r ${service.color} p-4 sm:p-6 ${service.platform === "Instagram" ? "text-white" : "text-gray-800"} relative overflow-hidden`}
                  >
                    <div
                      className={`absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 ${service.platform === "Instagram" ? "bg-white" : "bg-gray-300"} opacity-10 rounded-full -translate-y-12 sm:-translate-y-16 translate-x-12 sm:translate-x-16`}
                    ></div>
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
                We're not just another growth service. We're your dedicated partner in building authentic, lasting
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-white p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group"
                  >
        ...
        <section id="testimonials" className="py-12 sm:py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Success Stories</h2>
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center mb-4 space-y-2 sm:space-y-0 sm:space-x-4">
                      <div className="text-3xl sm:text-4xl lg:text-5xl">{testimonials[activeTestimonial].image}</div>
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-purple-600 to-pink-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg sm:text-xl text-purple-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
              Join thousands of creators who've accelerated their growth with our proven strategies. Your success story
              starts today.
            </p>
