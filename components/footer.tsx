...
// components/footer.tsx - Migrated from Vite app
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/services/instagram" className="hover:text-purple-400 transition-colors">
                  Instagram Growth
                </Link>
              </li>
              <li>
                <Link href="/services/tiktok" className="hover:text-purple-400 transition-colors">
                  TikTok Growth
                </Link>
              </li>
              <li>
                <Link href="/services/youtube" className="hover:text-purple-400 transition-colors">
                  YouTube Growth
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 VISIONBOOST. All rights reserved.</p>
